## <Understanding AI Literacy> 온라인 콘텐츠 개발 계획서

**1. 과정 개요**

* **과정명:** Understanding AI Literacy (인공지능 리터러시의 이해)
* **과정 목표:**
    * 인공지능(AI)의 기본 개념과 핵심 기술을 이해하고 학습한다.
    * 다양한 AI 도구 활용 및 실습을 통해 AI 활용 역량을 향상시킨다.
    * 자신의 전공 분야 및 관심사에 AI를 접목하는 방법을 학습하고 응용력을 키운다.
    * AI 기술의 영향력에 대한 비판적 사고 능력과 윤리적 인식을 함양한다.
    * SW융합 인재가 갖추어야 할 필수적인 디지털 역량을 강화한다.
* **교육 대상:** AI에 대한 이해를 높이고 자신의 분야에 AI를 활용하고자 하는 모든 학부생/대학원생
* **총 차시:** 13차시
* **차시당 시간:** 75분
* **수업 방식:** 온라인 이론 강의 + 실습 (개인/팀 활동 포함 가능)
* **핵심 학습 영역:**
    1.  AI와 데이터 이해 (AI & Data Understanding)
    2.  프롬프트 엔지니어링 (Prompt Engineering)
    3.  AI 활용 문제 해결 (AI Problem Solving)
    4.  AI에 대한 비판적 사고 (Critical Thinking about AI)
    5.  AI 윤리와 사회적 영향 (AI Ethics & Social Impact)

**2. 차시별 강의 계획 (총 13차시)**

| 차시 | 주제                                       | 핵심 학습 영역          | 주요 내용 (이론)                                                                 | 주요 활동 (실습)                                                                      | 시간 배분 (이론/실습) |
| :--- | :----------------------------------------- | :---------------------- | :------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------ | :-------------------- |
| 1    | **AI 리터러시의 시작:** 인공지능이란 무엇인가? | 1. AI와 데이터 이해     | AI 정의, 역사, 유형(약인공지능/강인공지능), 머신러닝/딥러닝 기초, AI 리터러시 중요성, 과정 소개 | 주변의 AI 사례 찾아보기, AI에 대한 자신의 생각 공유하기                                      | 40분 / 35분           |
| 2    | **AI의 연료:** 데이터 이해하기             | 1. AI와 데이터 이해     | 데이터의 정의 및 종류, 데이터 수집/정제/가공 중요성, 빅데이터 개념, 데이터 편향성 문제 소개 | 공공데이터 포털 등에서 관심 분야 데이터 탐색, 데이터 시각화 도구 체험(간단)                       | 40분 / 35분           |
| 3    | **AI와 대화하기:** 프롬프트 엔지니어링 기초  | 2. 프롬프트 엔지니어링  | LLM(대규모 언어 모델) 소개, 프롬프트 개념, 좋은 프롬프트의 조건 (명확성, 구체성, 맥락)      | 간단한 명령어(정보 요약, 번역, 질문 답변) 생성 및 결과 비교 (ChatGPT, Gemini 등 활용)      | 35분 / 40분           |
| 4    | **원하는 답을 얻는 기술:** 고급 프롬프트 전략 | 2. 프롬프트 엔지니어링  | 역할 부여, Few-shot 프롬프팅, Chain-of-Thought, 출력 형식 지정, 반복 개선            | 특정 역할(예: 마케터, 교사)을 부여하여 콘텐츠 생성, 복잡한 질문에 단계별 답변 유도 실습        | 35분 / 40분           |
| 5    | **AI로 문제 발견하기:** 문제 정의 및 분석   | 3. AI 활용 문제 해결    | AI 적용 가능 문제 유형 식별, 문제 정의 및 구체화 방법, AI 솔루션 탐색 방법 소개         | 자신의 전공/관심 분야에서 AI로 해결 가능한 문제점 브레인스토밍 및 정의하기 (팀 활동 가능)        | 40분 / 35분           |
| 6    | **다양한 AI 도구 탐험:** AI 서비스 활용 (1) | 3. AI 활용 문제 해결    | 텍스트 생성 AI 심화(블로그, 보고서 초안 작성), 이미지 생성 AI 소개 및 활용법         | 전공 관련 주제로 글쓰기 AI 활용하여 초안 작성, 키워드로 이미지 생성 실습 (DALL-E, Midjourney 등) | 30분 / 45분           |
| 7    | **다양한 AI 도구 탐험:** AI 서비스 활용 (2) | 3. AI 활용 문제 해결    | AI 기반 데이터 분석 도구(간단), AI 코딩 보조 도구, AI 영상/음악 생성 도구 소개        | 간단한 데이터 표 요약/분석 AI 도구 체험, 코드 생성/설명 요청 실습, AI 음악/영상 제작 도구 체험 | 30분 / 45분           |
| 8    | **전공에 AI 날개 달기:** 융합 프로젝트 기획 | 3. AI 활용 문제 해결    | 전공 분야별 AI 적용 사례 심층 분석, AI 활용 아이디어 구체화, 프로젝트 계획 수립 방법     | 5차시에서 정의한 문제에 대해 AI 도구를 활용한 해결 방안 구체화 및 미니 프로젝트 계획 발표      | 35분 / 40분           |
| 9    | **AI를 의심하라:** 비판적 사고 기초         | 4. AI에 대한 비판적 사고 | AI의 한계점 (환각 현상, 편향성), AI 생성 콘텐츠의 신뢰성 평가 기준                | AI가 생성한 정보(뉴스 기사, 요약문 등)의 사실 여부 확인 및 오류 찾아보기 실습                   | 40분 / 35분           |
| 10   | **가짜와의 전쟁:** 딥페이크와 AI 오용       | 4. AI에 대한 비판적 사고 | 딥페이크 기술 원리 및 식별 방법, AI 기반 가짜 뉴스/정보 확산 문제, AI 오용 사례 분석   | 딥페이크 의심 영상/이미지 분석 토론, AI 생성 콘텐츠 비판적으로 분석하고 평가하는 연습           | 40분 / 35분           |
| 11   | **AI 시대의 책임감:** AI 윤리 원칙        | 5. AI 윤리와 사회적 영향 | 공정성, 투명성, 책임성, 개인 정보 보호 등 AI 윤리 핵심 원칙, 데이터 프라이버시 문제     | AI 개발/활용 과정에서 발생 가능한 윤리적 딜레마 사례 토론                                | 45분 / 30분           |
| 12   | **AI와 사회의 미래:** 변화와 전망         | 5. AI 윤리와 사회적 영향 | AI가 일자리, 사회 구조, 교육 등에 미치는 영향, AI 관련 규제 및 거버넌스 동향, 책임감 있는 AI | AI 발전이 가져올 미래 사회 모습 예측 및 토론, AI 기술의 긍정적/부정적 영향 균형 있게 논의하기 | 45분 / 30분           |
| 13   | **나만의 AI 리터러시:** 종합 및 발전 방향   | 종합                     | 과정 전체 내용 요약 및 복습, AI 리터러시 지속적 학습 방법, 미니 프로젝트 결과 공유 (선택)  | 과정 후 AI 학습 계획 세우기, 과정 소감 및 피드백 공유                                   | 40분 / 35분           |

**3. 평가 방법 (제안)**

* **참여도 (20%):** 실시간 강의 참여, 토론 및 질의응답
* **과제 (50%):** 차시별 실습 결과물, AI 활용 아이디어 제출 등 (2-3회)
* **미니 프로젝트 (30%):** 전공/관심 분야 AI 활용 기획 또는 결과물 발표 (8차시 기획 기반, 13차시 최종 공유)
    * *평가 방법 및 비율은 실제 운영 상황에 맞게 조정 가능합니다.*
